  ...
  protected SupportSQLiteOpenHelper createOpenHelper(DatabaseConfiguration configuration) {
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(configuration, new RoomOpenHelper.Delegate(1) {
      ...
      public void createAllTables(SupportSQLiteDatabase _db) {
        _db.execSQL("CREATE TABLE IF NOT EXISTS `schedule_table` (`_id` INTEGER NOT NULL, `_day` TEXT NOT NULL, `_time` TEXT NOT NULL, PRIMARY KEY(`_id`))");
        _db.execSQL("CREATE TABLE IF NOT EXISTS room_master_table (id INTEGER PRIMARY KEY,identity_hash TEXT)");
        _db.execSQL("INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, 'c172681dc633d0a99c5576b660042ffb')");
      }
      ...
      protected RoomOpenHelper.ValidationResult onValidateSchema(SupportSQLiteDatabase _db) {
        ...
        _columnsScheduleTable.put("_id", new TableInfo.Column("_id", "INTEGER", true, 1, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsScheduleTable.put("_day", new TableInfo.Column("_day", "TEXT", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsScheduleTable.put("_time", new TableInfo.Column("_time", "TEXT", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        ...
        if (! _infoScheduleTable.equals(_existingScheduleTable)) {
          return new RoomOpenHelper.ValidationResult(false, "schedule_table(amc.g11.climbharder.Schedule).\n"
                  + " Expected:\n" + _infoScheduleTable + "\n"
                  + " Found:\n" + _existingScheduleTable);
        }
        return new RoomOpenHelper.ValidationResult(true, null);
      }
    }, "c172681dc633d0a99c5576b660042ffb", "356db411b451beb18219bac343d10273");
